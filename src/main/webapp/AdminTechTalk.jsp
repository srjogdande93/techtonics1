	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="AdminTechTalk.jsp">TechTonics</a>
			</div>
			<br />
			<h6>
			...
			<ul class="nav navbar-top-links navbar-right">
				...
				<li><a href="AddEvents.jsp"><i class="fa fa-sign-out fa-fw"></i>
						Add TechTalk</a></li>
			...
			<div class="col-lg-12">
				...
				<table id="events">
					...
					<tr>
						...
						<td><form action="UpdateEvent.jsp" method="post">
								<%
						...
						<td>
							<form action="DeleteServlet" method="post">
								<input type="hidden" id="hidden" name="id"
									value=<%=event.getEventid()%>> <input type="submit"
									id="gfhidden" name="delete" value="Delete">
							</form>
						</td>
					</tr>
					<%
